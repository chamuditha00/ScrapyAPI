...
if __name__ == '__main__':
    ...
    d = {"title":[], "price":[], "rating":[], "reviews":[],"availability":[], "link":[], "image_url":[], "category":"perfume"}
    ...
    #save to csv
    amazon_df.to_csv("amazon_perfume.csv", header=True, index=False)
    if(amazon_df.empty):
        print("empty")
    else:
        #READ CSV
        df = pd.read_csv('amazon_perfume.csv')
